...
WHERE CATEGORY_TRANSLATIONS.LANGUAGE = SYS_CONTEXT('USERENV', 'LANG')
WITH READ ONLY;
...
CREATE VIEW PERSONS_V AS SELECT 
    PERSON_ID PERSON_ID,
...
COMMENT ON COLUMN PRODUCT_TRANSLATIONS.SOURCE_LANG IS 'Actual language that this entry is is. If the entry has not yet been translated this value may be different from the defined LANGUAGE of the entry'
;
...
COMMENT ON COLUMN DISCOUNT_TRANSLATIONS.LANGUAGE IS 'The lannguage that this translation row represents '
;
